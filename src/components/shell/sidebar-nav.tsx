...
function NavLink({
  ...
  const linkClassName = cn(
    ...
    disabled
      ...
      : active
      ? "bg-sidebar-primary text-sidebar-primary-foreground font-[600] shadow-md rounded-[12px]"
  ...
  const linkContent = (
    <>
      <Icon className={cn("size-4 shrink-0 transition-all duration-300 group-hover:scale-110")} strokeWidth={2.2} />
