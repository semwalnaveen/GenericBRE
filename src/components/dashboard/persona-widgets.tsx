          ...
          <table className="w-full text-left text-xs">
            <thead className="sticky top-0 bg-card/95 backdrop-blur">
              <tr className="border-b font-medium text-muted-foreground">
                ...
                <th className="px-2 py-2 font-medium w-full">Applicant Name</th>
              ...
              {pendingApps.map((app) => {
                return (
                  <tr key={app.id} className="hover:bg-muted/50 transition-colors">
                    <td className="px-2 py-2 font-medium text-foreground whitespace-nowrap">{app.id}</td>
                    <td className="px-2 py-2 text-foreground whitespace-nowrap">{app.applicantName}</td>
                    <td className="px-2 py-2 text-muted-foreground whitespace-nowrap">{getProductName(app.productId)}</td>
